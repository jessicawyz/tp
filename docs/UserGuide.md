...
**Tip:** <br>
To match the results shown in the illustrations within our User Guide, we recommend replacing the contents of the `data/tuteetally.json` file with the data from the `data/test.json` file. <br>
